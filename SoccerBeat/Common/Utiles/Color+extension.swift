...
extension ShapeStyle where Self == Color {
    ...
    // MARK: - HeatmapView
    // red
    static var heatmap10: Self { .init(hex: 0xff3b30, alpha: 0.65)}
    static var heatmap20: Self { .init(hex: 0xff4f30, alpha: 0.65)}
    static var heatmap30: Self { .init(hex: 0xff6830, alpha: 0.65)}
    static var heatmap40: Self { .init(hex: 0xff8030, alpha: 0.65)}
    static var heatmap50: Self { .init(hex: 0xff9830, alpha: 0.65)}
    static var heatmap60: Self { .init(hex: 0xffaf30, alpha: 0.65)}
    static var heatmap70: Self { .init(hex: 0xffc730, alpha: 0.65)}
