...
extension ShapeStyle where Self == Color {
    ...
    // MARK: - HeatmapView
    static var heatmap10: Self { .init(hex: 0xff0000, alpha: 0.8)}
    static var heatmap20: Self { .init(hex: 0xff1100, alpha: 0.8)}
    static var heatmap30: Self { .init(hex: 0xff2600, alpha: 0.8)}
    static var heatmap40: Self { .init(hex: 0xff4000, alpha: 0.8)}
    static var heatmap50: Self { .init(hex: 0xff5c00, alpha: 0.8)}
    static var heatmap60: Self { .init(hex: 0xff7800, alpha: 0.8)}
    static var heatmap70: Self { .init(hex: 0xff9500, alpha: 0.8)}
    static var heatmap80: Self { .init(hex: 0xffb300, alpha: 0.8)}
    static var heatmap90: Self { .init(hex: 0xffd000, alpha: 0.8)}
    static var heatmap100: Self { .init(hex: 0xfff700, alpha: 0.8)}
}
