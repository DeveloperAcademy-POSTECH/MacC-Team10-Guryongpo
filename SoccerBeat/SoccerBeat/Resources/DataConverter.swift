...
func dataConverter(totalDistance: Double, maxHeartRate: Int, maxVelocity: Double, maxAcceleration: Double, sprintCount: Int, minHeartRate: Int, rangeHeartRate: Int, totalMatchTime: Int) -> [String: Double] {
