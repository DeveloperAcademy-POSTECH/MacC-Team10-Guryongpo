...
let fakeWorkoutData: [WorkoutData] = [
    WorkoutData(dataID: 1, date: "2023.10.09", time: "61:10", distance: 3.5, sprint: 3, velocity: 10.5, acceleration: 3.0, heartRate: ["max": 171, "min": 53], route: [], center: [0, 0], matchBadge: [-1,2,1]),
